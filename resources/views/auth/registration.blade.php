    ...
    <div class="container">
        ...
        <div class="col col-md-8 col-lg-6 col-xxl-5">
            ...
            <div class="shadow-xl p-4 p-lg-5 bg-white">
                <h1 class="text-center fw-bold mb-5 fs-2">Registration</h1>
                ...
                <form method="post" action="{{ route('register.post') }}">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="register-fullname">Fullname</label>
                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                            id="register-fullname" value="{{ old('name') }}" placeholder="John Doe">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="login-email"
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="password_confirmation" id="login-password"
                    ...
                    <button type="submit" class="btn btn-dark d-block w-100 my-4">Register Account</button>
                </form>
                <p class="d-block text-center text-muted">New customer? <a class="text-muted"
                        href="{{ route('login') }}">Login for an account</a></p>
            </div>
